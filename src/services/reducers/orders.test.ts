import {
  ...
  describe('ordersReducer', () => {
    ...
    it('should return the initial state', () => {
      expect(ordersReducer(undefined, {} as TOrdersActions)).toEqual(initialState);
    });
    ...
    it('should handle ORDERS_CONNECTION_ERROR', () => {
      const action: TOrdersActions = { type: ORDERS_CONNECTION_ERROR, payload: 'Connection error' };
      const expectedState: TOrdersState = {
        ...initialState,
    ...
    it('should handle ORDERS_CONNECTION_CLOSED', () => {
      ...
      expect(ordersReducer(initialStateWithOpenConnection, action)).toEqual(expectedState);
    });
