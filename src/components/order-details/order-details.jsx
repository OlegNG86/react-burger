...
function OrderDetails({ orderId, closeModal }) {
    ...
    return (
        <div className={styles.order}>
            <button onClick={closeModal} type='button' className={`${styles.order__closeButton}`}><img src='' alt='Закрыть окно' /></button>
            ...
            <img className={`mt-15 mb-15 ${styles.order__image}`} src='' alt='Ваш заказ принят' />
