...
import { showIngredientInModal, deleteIngredientFromModal } from '../../services/actions/ingredient-details';
...
function IngredientCard({ ingredient }) {
    ...
    return (
        <>
            <li key={ingredient._id} className={styles.card} onClick={handleOpenModal} ref={dragRef}>
